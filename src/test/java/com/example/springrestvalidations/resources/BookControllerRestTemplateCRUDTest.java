...
@ActiveProfiles("test")
public class BookControllerRestTemplateCRUDTest {
	    ...
	    //Getting exception:
//	    org.springframework.web.client.ResourceAccessException: I/O error on PATCH request for "http://localhost:62853/books/1": 
...
//		        String patchInJson = "{\"author\":\"mkyong\"}";
//		        HttpHeaders headers = new HttpHeaders();
//		        headers.setContentType(MediaType.APPLICATION_JSON);
//		        HttpEntity<String> entity = new HttpEntity<>(patchInJson, headers);
//	
